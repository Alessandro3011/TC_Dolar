...
public class loginController {
	...
	@ResponseBody
	public String registrarUsuario(String nombre,String dni,String user,String password,ModelMap model) {
...
//		String name = xCC[0].replace('%', ' ');
	...
	@ResponseBody
	public String updateUsuario(String nombre,String dni,String user,String codUser,String codPersona,String password,ModelMap model) {
		String resultado ="";
		int upPer = 0;
		int upUse = 0;
