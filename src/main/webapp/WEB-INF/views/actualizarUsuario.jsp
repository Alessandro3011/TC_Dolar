...
<body style="background-color: #f0f8ff">
	<div class="container">
            ...
            <center>
               ...
               <button type="button" class="btn btn-outline-danger" onclick="location.href='http://localhost:8080/TC_Dolar/home/usuarioAct?parametros=va,va'">CANCELAR</button>
            </center>
            </div>
                </form>
        </div>
...
function grabar(){ 
    ...
    if(user != "" && user!=null){
        ...
        type: 'POST',
          ...
          data: {"nombre":nombre,"dni":dni,"user":user,"codUser":codUser,"codPersona":codPersona,"password":password},
