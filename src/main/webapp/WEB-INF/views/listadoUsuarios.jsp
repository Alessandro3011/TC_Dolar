        ...
        <script type="text/javascript">
            ...
            function filtrar(){
                ...
                if((nombre == null || nombre=="") && (user == null || user==""))
                	window.location.href = 'http://localhost:8080/TC_Dolar/home/usuarioAct?parametros=va,va';
                else if (nombre == null || nombre=="")
                	window.location.href = 'http://localhost:8080/TC_Dolar/home/usuarioAct?parametros=va,'+user;
                else if(user == null || user=="")
                	window.location.href = 'http://localhost:8080/TC_Dolar/home/usuarioAct?parametros=' + nombre+',va';
                else
                	window.location.href = 'http://localhost:8080/TC_Dolar/home/usuarioAct?parametros=' + nombre+','+user;
            }
            ...
            function actualizar(pCodUsuario,pCodPersona){
                window.location.href = 'http://localhost:8080/TC_Dolar/home/usuarioActualizar?parametros='+ pCodUsuario+','+pCodPersona;
            }
