            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5 text-black">
                <form>
                  ...
                  <a class="small text-muted" href="http://localhost:8080/TC_Dolar/home/contrasenna">¿Olvidaste tu contraseña?</a>
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">¿No tienes una cuenta? <a href="http://localhost:8080/TC_Dolar/home/usuario"
    ...
    if(user != "" && user!=null){
        ...
        type: 'POST',
          ...
          success: function(data){
        	  if(data == "BIENVENIDO"){
        	  	window.location.href = 'http://localhost:8080/TC_Dolar/home/principal';
        	  }
        	  else{
